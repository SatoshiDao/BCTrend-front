...
export declare const getBBox: (element: IShapeBase, group: IGroup) => IBBox;
/**
 ...
 */
export declare const getLabelPosition: (pathShape: any, percent: number, refX: number, refY: number, rotate: boolean) => LabelStyle;
/**
...
export declare const getComboBBox: (children: ComboTree[], graph: IAbstractGraph, combo?: ICombo) => BBox;
