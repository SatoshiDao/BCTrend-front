...
function useGraph(graphClass, config, extra) {
    ...
    var updateEdges = function () {
        ...
        graph.getEdges().forEach(function (edge) {
            ...
            if (['fund-line', 'labels-line'].includes(edgeType)) {
                ...
                graph.updateItem(edge, {
                    type: edgeType,
                    label: (0, utils_1.getCommonConfig)(content, edgeCfgModel, graph),
                    labelCfg: {
                        style: (0, utils_1.getCommonConfig)(style, edgeCfgModel, graph),
                    },
    ...
    (0, react_1.useEffect)(function () {
        if (container.current && graphClass) {
            ...
            var _b = nodeCfg_1 !== null && nodeCfg_1 !== void 0 ? nodeCfg_1 : {}, nodeType_1 = _b.type, nodeSize = _b.size, nodeAnchorPoints_1 = _b.anchorPoints, nodeStateStyles = _b.nodeStateStyles, nodeStyle_1 = _b.style, nodeLabelCfg_1 = _b.title, linkCenter = _b.linkCenter, getChildren = _b.getChildren;
            ...
            if (tooltipCfg && (0, util_1.isFunction)(tooltipCfg.customContent)) {
                ...
                var createNode_1 = function (children) {
                    ...
                    react_dom_1.default.render(children, mountPoint);
                    return mountPoint;
                };
            ...
            graphRef.current = new g6_1.default[graphClass]({
                ...
                defaultNode: {
                    type: nodeType_1,
                    size: nodeSize,
                    anchorPoints: nodeAnchorPoints_1,
                    nodeCfg: nodeCfg_1,
                },
                defaultEdge: {
                    type: edgeType,
            ...
            var graphId = (0, utils_1.getGraphId)(graphRef.current);
            ...
            graph_1.node(function (node) {
                ...
                return {
                    ...
                    labelCfg: {
                        style: (0, utils_1.getCommonConfig)(style, node, graph_1),
                    },
            ...
            var getEdgeLabel_1 = function (edge) {
                ...
                if (['DecompositionTreeGraph', 'OrganizationGraph', 'RadialTreeGraph'].includes(name_1)) {
                    return (0, utils_1.getCommonConfig)(content, edge, graph_1);
                }
            ...
            if (!['fund-line', 'labels-line'].includes(edgeType)) {
                graph_1.edge(function (edge) {
                    ...
                    return {
                        ...
                        labelCfg: {
                            style: (0, utils_1.getCommonConfig)(style, edge, graph_1),
                        },
            ...
            if (markerCfg) {
                ...
                sourceGraph.includes(name_1) ? (0, utils_1.bindSourceMapCollapseEvents)(graph_1) : (0, utils_1.bindDefaultEvents)(graph_1, level, getChildren);
            }
    ...
    (0, react_1.useEffect)(function () {
        if (graphRef.current && toolbarCfg) {
            (0, toolbar_1.createToolbar)({ graph: graphRef.current, container: container.current, toolbarCfg: toolbarCfg });
        }
    }, [graphRef, toolbarCfg]);
    (0, react_1.useEffect)(function () {
        return function () {
