...
import { ArrowConfig as G6ArrowConfig, Edge, EdgeConfig as G6EdgeConfig, Graph, IEdge, IG6GraphEvent, IGraph, IGroup, INode, IPoint, IShape, LabelStyle, ModelConfig, Node, NodeConfig as G6NodeConfig, ShapeStyle, StateStyles } from '@antv/g6';
...
export declare type TreeGraphData = NodeData<{
    title?: string;
    items?: CardItems[];
}>;
export declare type FlowGraphNodeData = NodeData<{
    title?: string;
    items?: CardItems[];
}[]>;
export declare type FlowGraphEdgeData = EdgeData<string>;
export interface FlowGraphDatum {
    nodes: FlowGraphNodeData[];
    edges: FlowGraphEdgeData[];
}
export { StateStyles, ShapeStyle, Node, Edge, IGraph, ModelConfig, IG6GraphEvent, IGroup, LabelStyle, INode, IEdge, Graph, IPoint, IShape, };
